// PaymentGateway.java
// This class NEVER writes the words GCashPayment, MayaPayment or CashPayment.[cite: 1]
...
public class PaymentGateway {
    ...
    public void showServiceFees() {
        ...
        for (Payment p : payments) {
            System.out.printf("[%d] %-6s standard 2%%: PHP %8.2f  student 1%%: PHP %8.2f\n",
                    p.getId(), p.provider(), p.serviceFee(), p.serviceFee(0.01));
        }
    }

    // TODO 10: Finish findById(int id).[cite: 1]
    ...
    // TODO 11: Finish totalCollected().[cite: 1]
    ...
    // TODO 12: Finish refundAll().[cite: 1]
