    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        System.out.printf("Current Balance: PHP %.2f%n", account.getBalance());
                        break;
                    ...
                    case 4:
                        double total = atm.depositAll(account, 100.0, 250.50, 300.0);
                        System.out.printf("Deposited multiple amounts. Total added: PHP %.2f%n", total);
                        System.out.printf("New balance: PHP %.2f%n", account.getBalance());
                        break;

                    case 5:
                        System.out.println("--- Pass-by-Value Demo ---");
                        System.out.printf("Balance before tryToReplace: PHP %.2f%n", account.getBalance());
                        atm.tryToReplace(account);
                        System.out.printf("Balance after tryToReplace: PHP %.2f (Unchanged)%n", account.getBalance());

                        atm.addBonus(account, 50.0);
                        System.out.printf("Balance after addBonus(50): PHP %.2f (Mutated)%n", account.getBalance());
                        break;
